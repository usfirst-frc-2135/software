...
PigeonIMU m_pigeonIMU{0};
    ...
    static constexpr auto leftMotorModel = frc2135::make_simple_motor_model(ks, kv, ka);
    static constexpr auto rightMotorModel = frc2135::make_simple_motor_model(ks, kv, ka);

    frc2135::SimulationState m_simStateLeft;
    frc2135::SimulationState m_simStateRight;
    radian_t m_simHeading = 0_rad;
