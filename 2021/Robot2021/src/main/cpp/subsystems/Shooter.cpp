...
Shooter::Shooter()
{
    ...
    if (m_indexer.IsFwdSolenoidBlackListed())
        spdlog::error("SH Shooter Indexer FWD Solenoid is BLACKLISTED");
    else if (m_indexer.IsRevSolenoidBlackListed())
        spdlog::error("SH Shooter Indexer REV Solenoid is BLACKLISTED");
    else
        spdlog::info("SH Shooter Indexer FWD Solenoid is FUNCTIONAL");
    ...
    if (m_talonValidSH10)
    {
        ...
        m_motorSH10.ConfigSelectedFeedbackSensor(
...
void Shooter::SetShooterSpeed(int level)
{
    ...
    spdlog::info(
        "SH Velocity Output -> {} RPM {} -> {} Native Unit {}-> {}",
        m_targetOutput,
        m_curVelocityRPM,
        m_targetVelocityRPM,
        curVelocityNative,
        m_targetVelocityNative);
}
