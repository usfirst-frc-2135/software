...
void Drivetrain::SimulationPeriodic()
{
    // This method will be called once per scheduler run when in simulation
     m_driverSim.SetInputs(units::volt_t{m_motorL1.Get()} *
                                      frc::RobotController::GetInputVoltage(),
                                  units::volt_t{-m_motorR3.Get()} *
                                      frc::RobotController::GetInputVoltage());
...
void Drivetrain::UpdateOdometry(void)
{
    ...
    {
        m_odometry.Update(m_driverSim.GetHeading(), m_driverSim.GetLeftPosition(), m_driverSim.GetRightPosition());
    }
}
