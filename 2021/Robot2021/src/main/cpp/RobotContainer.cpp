...
void RobotContainer::ConfigureButtonBindings()
{
    ...
    frc2::JoystickButton m_shEnd{ &m_operatorPad, (int)frc::XboxController::Button::kBumperLeft };
    ...
    frc2::JoystickButton m_inDeploy{ &m_operatorPad, (int)frc::XboxController::Button::kA };
    frc2::JoystickButton m_inStow{ &m_operatorPad, (int)frc::XboxController::Button::kY };
    ...
    m_shRun.WhenPressed(ShooterRun(1, &m_shooter), true);
    m_shEnd.WhenPressed(ShooterRun(0, &m_shooter), true);
