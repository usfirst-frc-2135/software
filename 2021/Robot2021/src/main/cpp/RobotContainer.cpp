...
frc2::JoystickButton m_clAscendD{&m_driverPad, 1};
...
m_clAscendD.WhileHeld(ClimberRun(0, &m_climber), true);
m_clDeployD.WhenPressed(ClimberDeploy(false, &m_climber), true);
...
frc2::JoystickButton m_clAscendO{&m_operatorPad, 1};
frc2::JoystickButton m_clDeployO{&m_operatorPad, 4};

m_clAscendO.WhileHeld(ClimberRun(0, &m_climber), true);
m_clDeployO.WhenPressed(ClimberDeploy(false, &m_climber), true);
}
