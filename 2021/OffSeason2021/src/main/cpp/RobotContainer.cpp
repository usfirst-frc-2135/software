        ...
        &m_drivetrain)
{
    ...
    frc::SmartDashboard::PutData("Shooter Run: SHDIR_STOP", new ShooterRun(false, 0, &m_shooter));
    frc::SmartDashboard::PutData("Shooter Run: SHDIR_SHOOT", new ShooterRun(true, 1, &m_shooter));
    ...
    frc::SmartDashboard::PutData(
        ...
        new ShooterRun(true, Shooter::SHOOTERSPEED_SMARTDASH, &m_shooter));
    frc::SmartDashboard::PutData(
        "Intaking Action",
...
void RobotContainer::ConfigureButtonBindings()
{
    ...
    m_shootingPrimeOp.WhenPressed(ShootingPrime(&m_shooter), true);
    m_shooterOffOp.WhenPressed(ShooterRun(false, Shooter::SHOOTERSPEED_STOP, &m_shooter), true);
}
