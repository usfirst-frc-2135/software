        ...
        &m_drivetrain)
{
    ...
    m_climber.SetDefaultCommand(ClimberRun(1, &m_climber));
...
void RobotContainer::ConfigureButtonBindings()
{
    ...
    m_shootingOp.WhenPressed(ShooterRun(Shooter::SHOOTERSPEED_FORWARD, &m_shooter));
    m_shootingOp.WhenReleased(ShooterRun(Shooter::SHOOTERSPEED_STOP, &m_shooter));
}
