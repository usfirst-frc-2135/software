...
std::shared_ptr<CANTalon> RobotMap::shooterMotorIntake;
std::shared_ptr<CANTalon> RobotMap::shooterMotorLowerShooter;
std::shared_ptr<CANTalon> RobotMap::shooterMotorUpperShooter;
...
void RobotMap::init() {
    ...
    shooterMotorIntake.reset(new CANTalon(8));
    lw->AddActuator("Shooter", "MotorIntake", shooterMotorIntake);
    
    shooterMotorLowerShooter.reset(new CANTalon(6));
    lw->AddActuator("Shooter", "MotorLowerShooter", shooterMotorLowerShooter);
    
    shooterMotorUpperShooter.reset(new CANTalon(7));
    lw->AddActuator("Shooter", "MotorUpperShooter", shooterMotorUpperShooter);
