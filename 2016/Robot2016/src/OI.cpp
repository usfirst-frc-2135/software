...
#include "Commands/DriveBrakeToggle.h"
...
#include "Commands/ShootPIDControl.h"
...
OI::OI() {
    ...
    pIDControl.reset(new JoystickButton(controlBoardB.get(), 8));
    pIDControl->WhenPressed(new ShootPIDControl());
    brakeMode.reset(new JoystickButton(controlBoardB.get(), 5));
    brakeMode->WhenPressed(new DriveBrakeToggle());
    shootReverse.reset(new JoystickButton(controlBoardB.get(), 4));
    shootReverse->WhileHeld(new ShootPresets(-1));
    shootHigh.reset(new JoystickButton(controlBoardB.get(), 2));
