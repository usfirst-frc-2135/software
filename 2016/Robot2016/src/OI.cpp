...
OI::OI() {
    ...
    shootHigh.reset(new JoystickButton(operatorJoystick.get(), 12));
    shootHigh->WhileHeld(new ShootPresets(1));
    shootMid.reset(new JoystickButton(operatorJoystick.get(), 11));
    shootMid->WhileHeld(new ShootPresets(2));
    shootLow.reset(new JoystickButton(operatorJoystick.get(), 10));
