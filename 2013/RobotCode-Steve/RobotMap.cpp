...
AnalogChannel* RobotMap::climberLeftLimit = NULL;
AnalogChannel* RobotMap::climberRightLimit = NULL;
...
void RobotMap::init() {
	...
	climberLeftLimit = new AnalogChannel(1, 2);
	lw->AddSensor("Climber", "Left Limit", climberLeftLimit);
	
	climberRightLimit = new AnalogChannel(1, 3);
	lw->AddSensor("Climber", "Right Limit", climberRightLimit);
	...
	driverStationLCD->PrintfLine(DriverStationLCD::kUser_Line1, "Steve 2013 - Ultimate Ascent");
