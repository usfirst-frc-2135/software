...
#include "Commands/FiringPinExtend.h"
#include "Commands/FiringPinRetract.h"
...
OI::OI() {
	...
	operatorButton3->WhileHeld(new ShootFrisbee());
	...
	operatorTrigger->WhileHeld(new FiringPinExtend());
	...
	SmartDashboard::PutData("Firing Pin Retract", new FiringPinRetract());
	SmartDashboard::PutData("Firing Pin Extend", new FiringPinExtend());
