...
AnalogChannel* RobotMap::batteryBatteryVoltage = NULL;
...
void RobotMap::init() {
	...
	batteryBatteryVoltage = new AnalogChannel(1, 7);
	lw->AddSensor("Battery", "Battery Voltage", batteryBatteryVoltage);
