...
AnalogChannel* RobotMap::batteryMonitorBatteryVoltage = NULL;
...
void RobotMap::init() {
	...
	shooterEntryShooterEncoder->SetDistancePerPulse(1.0);
	...
	shooterExitShooterEncoder->SetDistancePerPulse(1.0);
	...
	batteryMonitorBatteryVoltage = new AnalogChannel(1, 7);
	lw->AddSensor("Battery Monitor", "Battery Voltage", batteryMonitorBatteryVoltage);
