...
HWheel::HWheel() : Subsystem("HWheel") {
	...
	hWheelDrive = new RobotDrive(motorHL, motorHR);
...
void HWheel::HWheelDriveWithJoystick( Joystick *joystick2 )
{
	hWheelDrive->ArcadeDrive( joystick2->GetY() * m_orientationNormal, joystick2->GetX(), true );
}
