...
public class LineTracker extends SimpleRobot {
    ...
    DigitalInput minShouldersafe = new DigitalInput(13); // lower pivot limit switch
    DigitalInput maxShouldersafe = new DigitalInput(12); // upper pivot limit switch
    DigitalInput minArmsafe = new DigitalInput(11); // lower pivot limit switch
    DigitalInput maxArmsafe = new DigitalInput(10); // upper pivot limit switch
    Encoder armEncoder = new Encoder(5, 6); // Encoder to measure arm extension
    ...
    public LineTracker() {
        ...
        armEncoder.setDistancePerPulse(0.25); // Each pulse is 1/4 inch
    ...
    public void operatorControl() {
        ...
        arm = new PIDController(0.0, 0.0, 0.0, armEncoder, armMotor);
        arm.enable();
        ...
        while (isEnabled() && isOperatorControl()) {
            ...
            if (leftJoystick.getRawButton(3)) {
            armSetPoint = 20.0;  // Set arm to 20 inches
            }
