...
DoubleSolenoid* RobotMap::shooterShooterSolenoid = NULL;
...
void RobotMap::init() {
	...
	sweeperDeployCylinder = new DoubleSolenoid(1, 3, 4);      
	
	
	sweeperSweeperSolenoid = new DoubleSolenoid(1, 7, 8);      
	
	
	shooterShooterSolenoid = new DoubleSolenoid(1, 5, 6);      
