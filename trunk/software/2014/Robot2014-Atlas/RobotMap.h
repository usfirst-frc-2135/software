...
public:
	...
	static DoubleSolenoid* sweeperSweeperSolenoid;
	static SpeedController* sweeperSweeperMotor;
	static DoubleSolenoid* shooterShooterReleaseSolenoid;
	static SpeedController* shooterShooterRetractMotor;
	static DigitalInput* shooterShooterLimitSwitch;
