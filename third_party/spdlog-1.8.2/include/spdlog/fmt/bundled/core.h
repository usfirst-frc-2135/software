...
{
    static_assert(formattable<T>(), "Cannot format an argument. To make type T formattable provide a "
...
template<typename Char>
void vformat_to(buffer<Char> &buf, basic_string_view<Char> format_str, basic_format_args<FMT_BUFFER_CONTEXT(type_identity_t<Char>)> args,
