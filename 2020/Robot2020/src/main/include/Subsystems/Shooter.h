...
Shooter();
	...
	enum {
		NOCHANGE_SPEED = -1,		//	No change in speed--maintain current velocity
		STOP_SPEED = 0,				//	Stop shooter
		SLOW_SPEED = 1,				//	Slow shooter velocity
		FAST_SPEED = 2,				//  Fast shooter velocity
		SMARTDASH_SPEED = 3			//  Read target velocity from SmartDashboard
	};
