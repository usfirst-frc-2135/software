...
void Robot::RobotInit()
{
    ...
    m_autonChooser.AddOption("Auto Stop", new AutoStop());
    m_autonChooser.AddOption("Auto Drive Dist: DEFAULT", new AutoDriveDist(0));
    m_autonChooser.AddOption("Auto Shoot Drive", new AutoShootDrive());

    m_autonChooser.SetDefaultOption("Auto Stop", new AutoStop());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS

    frc::SmartDashboard::PutData("Auto Modes", &m_autonChooser);
...
{
    autonomousCommand = m_autonChooser.GetSelected();
