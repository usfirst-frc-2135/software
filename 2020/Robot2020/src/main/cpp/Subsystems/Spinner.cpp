...
void Spinner::Initialize(void)
{
    ...
    if (m_talonValidSP12)
    {
        motorSP12->Set(ControlMode::PercentOutput, 0.0);

        motorSP12->ConfigSelectedFeedbackSensor(FeedbackDevice::CTRE_MagEncoder_Relative, kCANTimeout);
        motorSP12->SetSensorPhase(false);
        motorSP12->SetSelectedSensorPosition(0, kCANTimeout);
    }
}
...
{
    frc2135::TalonUtils::TalonFaultDump("SP 12", motorSP12);
}
