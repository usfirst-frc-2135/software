...
AddChild("Shifter", shifter);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
        ...
        m_talonValidL1 = frc2135::TalonFXUtils::TalonFXCheck(motorL1, "DT", "L1");
        m_talonValidL2 = frc2135::TalonFXUtils::TalonFXCheck(motorL2, "DT", "L2");
        m_talonValidR3 = frc2135::TalonFXUtils::TalonFXCheck(motorR3, "DT", "R3");
        m_talonValidR4 = frc2135::TalonFXUtils::TalonFXCheck(motorR4, "DT", "R4");
...
void Drivetrain::FaultDump(void) {
    ...
    frc2135::TalonFXUtils::TalonFXFaultDump("DT L1", motorL1);
    frc2135::TalonFXUtils::TalonFXFaultDump("DT L2", motorL2);
    frc2135::TalonFXUtils::TalonFXFaultDump("DT R3", motorR3);
	frc2135::TalonFXUtils::TalonFXFaultDump("DT R4", motorR4);
	PigeonIMUFaultDump();

    // Dump Pigeon faults
    // frc2135::TalonFXUtils::PigeonIMUFaultDump("DT IMU", gyro);
