...
private:
	...
	std::shared_ptr<frc::JoystickButton> rocket3;
	...
	std::shared_ptr<frc::JoystickButton> lifterBackMove;
	std::shared_ptr<frc::JoystickButton> lifterFrontMove;
	std::shared_ptr<frc::JoystickButton> toggleDrive;
...
public:
	...
	bool	m_isCargo = true;	// Note this must match GPShift global
