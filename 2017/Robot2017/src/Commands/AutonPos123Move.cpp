...
AutonPos123Move::AutonPos123Move() {
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	...
	// TODO: Put this back to driving a distance based on leg1
	// TODO: make a new command for low gear+brake mode and place it on dashboard
