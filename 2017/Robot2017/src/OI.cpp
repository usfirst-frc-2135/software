...
#include "Commands/AutonDriveTurnDistance.h"
...
OI::OI() {
    ...
    SmartDashboard::PutData("Auton Drive Turn Distance", new AutonDriveTurnDistance());
    SmartDashboard::PutData("Auton Drive Turn: DEFAULT", new AutonDriveTurn(0));
    SmartDashboard::PutData("Auton Drive Timed: DEFAULT", new AutonDriveTimed(0));
