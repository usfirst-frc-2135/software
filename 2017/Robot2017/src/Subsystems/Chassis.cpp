...
//    robotDrive = RobotMap::chassisRobotDrive;
    ...
    leftGroup = RobotMap::chassisLeftGroup;
    rightGroup = RobotMap::chassisRightGroup;
...
void Chassis::Initialize(frc::Preferences *prefs)
{
	...
	motorL1->ConfigPeakOutputForward(100*peakOutputVoltage/12.0, 100);
	motorL1->ConfigPeakOutputReverse(100*peakOutputVoltage/12.0, 100);
	motorR3->ConfigPeakOutputForward(100*peakOutputVoltage/12.0, 100);
	motorR3->ConfigPeakOutputReverse(100*peakOutputVoltage/12.0, 100);
	...
	motorL1->ConfigNominalOutputForward(100*nominalOutputVoltage/12.0, 100);
	motorL1->ConfigNominalOutputReverse(100*nominalOutputVoltage/12.0, 100);
	motorR3->ConfigNominalOutputForward(100*nominalOutputVoltage/12.0, 100);
	motorR3->ConfigNominalOutputReverse(100*nominalOutputVoltage/12.0, 100);
...
//	robotDrive->ArcadeDrive( yValue, xValue, true );
	drive->ArcadeDrive( 0.0, 0.3, true );
}
