...
private:
	...
	std::shared_ptr<TalonSRX> motorL1;
	std::shared_ptr<TalonSRX> motorR3;
	std::shared_ptr<TalonSRX> motorL2;
	std::shared_ptr<TalonSRX> motorR4;
...
//	10/22 Test: L-encoder: -10620.0; R-encoder: 10602.0 for 290 inches distance
	...
	const double				InchesPerCount = WheelDiaInches / (double)Encoder_CPR;
...
public:
	...
	int GetEncoderPosition(std::shared_ptr<TalonSRX> mtr);
};
