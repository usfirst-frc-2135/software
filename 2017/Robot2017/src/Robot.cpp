...
void Robot::RobotInit() {
	...
	chooser.AddDefault("0) Auton Default", new AutonDefault());
	chooser.AddObject("1) Pos 123 Move", new AutonPos123Move());
	chooser.AddObject("2) Pos 1 Gear", new AutonPos1DeliverGear());
	chooser.AddObject("3) Pos 2 Gear", new AutonPos2DeliverGear());
	chooser.AddObject("4) Pos 3 Gear", new AutonPos3DeliverGear());
