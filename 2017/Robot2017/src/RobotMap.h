...
public:
	...
	static std::shared_ptr<CANTalon> intakeMotorIn;
	static std::shared_ptr<DoubleSolenoid> intakeArmDeploy;
	static std::shared_ptr<CANTalon> hopperAgitator;
	static std::shared_ptr<CANTalon> shooterMotor;
	static std::shared_ptr<Servo> shooterGate;
	static std::shared_ptr<DoubleSolenoid> deliveryGearRelease;
	static std::shared_ptr<DoubleSolenoid> deliveryDoorOpen;
	static std::shared_ptr<CANTalon> climberWinch;
