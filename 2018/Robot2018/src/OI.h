...
private:
	...
	std::shared_ptr<frc::JoystickButton> gripperWristAcquire;
	std::shared_ptr<frc::JoystickButton> gripperWristDeliver;
	std::shared_ptr<frc::JoystickButton> gripperWristStow;
