...
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	...
	config->GetValueAsDouble("AutoPos1Switch", cmdDistance, 97.25);

	std::string	alliSwitch;
	std::printf("2135: Auto Pos 1 Switch - Init %5.3f inches\n", cmdDistance);
    ...
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
	  ...
	  if (alliSwitch == ROBOT_FMS_LEFT)			// If FMS reports LEFT side
