...
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	...
	std::printf("2135: Auto Pos 3 Switch -  Init Leg1 %4.2f in, Turn1 %4.1f deg, Leg3 %4.2f in\n",
    ...
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
	  ...
	  AddSequential(new AutoDriveDist(cmdDistLeg1)); // To the turn

	  AddSequential(new AutoDriveTurn(cmdDistTurn));	// Turn (45 degrees)
