...
//TEST    motorR12 = RobotMap::elevatorMotorR12;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

    motorL11->SetInverted(false);			// Sets the Talon invertion to false
//TEST    motorR12->SetInverted(false);			// Sets the Talon invertion to false
...
//TEST    motorR12->Set(ControlMode::Follower, 11);

    // Set to brake mode (in comparison to coast)
    motorL11->SetNeutralMode(NeutralMode::Brake);
//TEST    motorR12->SetNeutralMode(NeutralMode::Brake);
