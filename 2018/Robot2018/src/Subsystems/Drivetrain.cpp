...
Drivetrain::Drivetrain() : frc::Subsystem("Drivetrain") {
	...
	motorL1->Config_kP(m_slotIndex, m_proportional, m_timeout);
	motorR3->Config_kP(m_slotIndex, m_proportional, m_timeout);

	double percentOutput = 1.0;
	config->GetValueAsDouble("DT_PercentOutput", percentOutput, 1.0);

	motorL1->ConfigPeakOutputForward(percentOutput, m_timeout);
	motorL1->ConfigPeakOutputReverse(-percentOutput, m_timeout);
	motorR3->ConfigPeakOutputForward(percentOutput, m_timeout);
	motorR3->ConfigPeakOutputReverse(-percentOutput, m_timeout);
...
{
	return mtr->GetSelectedSensorPosition(m_pidIndex);
}
