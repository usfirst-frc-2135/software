...
void RobotMap::init() {
	...
	driveControlLeft = new PIDController(0.2, 0.0, 0.0, chassisLeftEncoder, chassisLeftMotor);
	driveControlRight = new PIDController(0.2, 0.0, 0.0, chassisRightEncoder, chassisRightMotor);
}
