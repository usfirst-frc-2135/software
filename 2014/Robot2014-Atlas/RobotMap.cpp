...
DigitalInput* RobotMap::shooterShooterLimitSwitch = NULL;
...
void RobotMap::init() {
	...
	shooterShooterLimitSwitch = new DigitalInput(1, 5);
	lw->AddSensor("Shooter", "Shooter Limit Switch", shooterShooterLimitSwitch);
