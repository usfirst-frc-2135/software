...
#include "Commands/ShooterDisengage.h"
...
OI::OI() {
	...
	SmartDashboard::PutData("Shooter Engage", new ShooterEngage());
	SmartDashboard::PutData("Shooter Disengage", new ShooterDisengage());
