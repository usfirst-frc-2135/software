...
#include "Commands/SweeperMotorAquire.h"
...
OI::OI() {
	...
	operatorSweeperAquire->WhileHeld(new SweeperMotorAquire());
	...
	driverSweeperAquire = new JoystickButton(driverJoystick, 12);
	driverSweeperAquire->WhileHeld(new SweeperMotorAquire());
	...
	SmartDashboard::PutData("Sweeper Motor Aquire", new SweeperMotorAquire());
