...
Chassis::Chassis() : Subsystem("Chassis") {
	...
	drvTrain->SetInvertedMotor(RobotDrive::kRearLeftMotor, m_leftInvertedMotor);
	drvTrain->SetInvertedMotor(RobotDrive::kRearRightMotor, m_rightInvertedMotor);
...
void Chassis::ReverseDriveTrain( void ) 
{
	...
	drvTrain->SetInvertedMotor(drvTrain->kRearLeftMotor, m_leftInvertedMotor);
	drvTrain->SetInvertedMotor(drvTrain->kRearRightMotor, m_rightInvertedMotor);
}
//
