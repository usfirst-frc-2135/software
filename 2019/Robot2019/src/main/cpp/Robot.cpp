...
void Robot::RobotInit() {
	...
	chooser.AddOption("Auto Pos 1", new AutoPos1());
	chooser.AddOption("Auto Pos 2", new AutoPos2());
	chooser.AddOption("Auto Pos 3", new AutoPos3());
...
void Robot::FMSGameDataRead(void) {
	...
	if (gameData.compare(prevGameData) != 0) {
		...
		frc::SmartDashboard::PutString(ROBOT_FMSALLISWITCH, FMSGameDataString(fmsAlliSwitch));
		frc::SmartDashboard::PutString(ROBOT_FMSSCALE, FMSGameDataString(fmsScale));
		frc::SmartDashboard::PutString(ROBOT_FMSOPPSWITCH, FMSGameDataString(fmsOppSwitch));
	}
}
