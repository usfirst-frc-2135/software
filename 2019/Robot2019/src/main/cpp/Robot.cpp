...
std::shared_ptr<CargoIntake> Robot::cargoIntake;
std::shared_ptr<HatchPanelIntake> Robot::hatchPanelIntake;
...
void Robot::RobotInit() {
    ...
    cargoIntake.reset(new CargoIntake());
    hatchPanelIntake.reset(new HatchPanelIntake());
