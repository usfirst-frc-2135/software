...
WristBump::WristBump(bool direction): frc::Command() {
...
void WristBump::Execute() {

}

// Make this return true when this Command no longer needs to run execute()
bool WristBump::IsFinished() {
...
void WristBump::End() {
	std::printf("2135: WristBump - End\n");
}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void WristBump::Interrupted() {
	std::printf("2135: WristBump - Interrupted\n");
}
