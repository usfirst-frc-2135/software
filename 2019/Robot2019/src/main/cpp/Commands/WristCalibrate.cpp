...
#include "WristCalibrate.h"

// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR

WristCalibrate::WristCalibrate(): frc::Command() {
...
void WristCalibrate::Interrupted() {
	std::printf("2135: WristCalibrate - Interrupted\n");
