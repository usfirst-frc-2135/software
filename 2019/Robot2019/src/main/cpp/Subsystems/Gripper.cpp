...
Gripper::Gripper() : frc::Subsystem("Gripper") {
    ...
    motorL11.reset(new WPI_TalonSRX(11));
    motorR12.reset(new WPI_TalonSRX(12));
...
void Gripper::Periodic() {
	...
	if (m_gripperDebug) {
		frc::SmartDashboard::PutNumber("GR_Output_L11", outputL11);
		frc::SmartDashboard::PutNumber("GR_Current_L11", currentL11);
		frc::SmartDashboard::PutNumber("GR_Output_R12", outputR12);
		frc::SmartDashboard::PutNumber("GR_Current_R12", currentR12);
	}
}
