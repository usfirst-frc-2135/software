...
Drivetrain::Drivetrain() : frc::Subsystem("Drivetrain") {
   ...
   //Retrieve drivetrain modifiers from RobotConfig
	...
	frc::SmartDashboard::PutNumber(AUTO_DT_DD, temp);
	config->GetValueAsDouble("AutoDriveTurn", temp, 90.0);
	frc::SmartDashboard::PutNumber(AUTO_DT_DT, temp);
...
void Drivetrain::Periodic() {
	...
	if (m_driveDebug) {
		...
		frc::SmartDashboard::PutNumber("DT_GyroDispX", gyroDispX);
		frc::SmartDashboard::PutNumber("DT_GyroDispY", gyroDispY);
	}
}
...
//	frc::SmartDashboard::PutNumber("DD PID L", curCounts_L);
//	frc::SmartDashboard::PutNumber("DD PID R", curCounts_R);
//	frc::SmartDashboard::PutNumber("DD TIME", m_safetyTimer.Get());
