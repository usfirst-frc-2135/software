...
OI::OI() {
    ...
    ground.reset(new frc::JoystickButton(controlBoard2.get(), 3));
    ground->WhenPressed(new MoveGround());
    loadingStation.reset(new frc::JoystickButton(controlBoard2.get(), 2));
    loadingStation->WhenPressed(new MoveLoadingStation());
    stow.reset(new frc::JoystickButton(controlBoard2.get(), 1));
    stow->WhenPressed(new MoveStow());
    controlBoard.reset(new frc::Joystick(1));
    
    intakeStop.reset(new frc::JoystickButton(controlBoard.get(), 10));
