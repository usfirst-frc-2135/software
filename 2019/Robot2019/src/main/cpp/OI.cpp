...
OI::OI() {
    ...
    moveCargoShip.reset(new frc::JoystickButton(controlBoard.get(), 15));
    moveCargoShip->WhenPressed(new MoveCargoShipCargo());
    moveRocket3.reset(new frc::JoystickButton(controlBoard.get(), 12));
    moveRocket3->WhenPressed(new MoveRocketLevel3());
    moveRocket2.reset(new frc::JoystickButton(controlBoard.get(), 13));
    moveRocket2->WhenPressed(new MoveRocketLevel2());
    moveRocket1.reset(new frc::JoystickButton(controlBoard.get(), 14));
    moveRocket1->WhenPressed(new MoveRocketLevel1());
    ...
    wristBumpDown.reset(new frc::JoystickButton(controlBoard.get(), 22));
    wristBumpDown->WhileHeld(new WRBump(false));
    wristBumpUp.reset(new frc::JoystickButton(controlBoard.get(), 21));
    wristBumpUp->WhileHeld(new WRBump(true));
    elbowBumpDown.reset(new frc::JoystickButton(controlBoard.get(), 20));
    elbowBumpDown->WhileHeld(new EBBump(false));
    elbowBumpUp.reset(new frc::JoystickButton(controlBoard.get(), 19));
    elbowBumpUp->WhileHeld(new EBBump(true));
    elevatorBumpDown.reset(new frc::JoystickButton(controlBoard.get(), 18));
    elevatorBumpDown->WhileHeld(new ELBump(false));
    elevatorBumpUp.reset(new frc::JoystickButton(controlBoard.get(), 17));
